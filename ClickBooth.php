...
class ClickBooth extends BaseNetwork implements iNetwork {
	static $networkid = "1";
	static $cookiejar = "";
	static $CAKE_CLICK_BOOTH_BASE_WEBSERVICE_URL = "http://affiliates.clickbooth.com/";
	static $CAKE_CLICK_BOOTH_API_KEY = "XXXXX";
	...
	private function login() {
		...
		$url = "http://affiliates.clickbooth.com/affiliates/login.ashx";
	...
	private function getNetworkRecords($date) {
		...
		$url = "http://affiliates.clickbooth.com/affiliates/Extjs.ashx?s=subaffsummary";
	...
	private function getLeadSummary($date) {
		...
		$url = "http://affiliates.clickbooth.com/affiliates/Extjs.ashx?s=leadreport";
